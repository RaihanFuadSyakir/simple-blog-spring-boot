...
public class CommentController {
    ...
    public List<Comment> getCommentsByPostIdAndCommentLikeDesc(@RequestParam("post_id") Long postId,
            @RequestParam("query") String query) {
        List<Comment> comments = commentService.findCommentByPostIdAndCommentLikeDesc(postId, query);
        return comments;
    }
